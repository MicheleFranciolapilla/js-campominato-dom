...
const   it_txt              =   `<h3 style = "color : blue; text-align : center">Introduzione al progetto "Campo Minato"</h3>
 ...
 <span style = "color : green;  user-select : text">michele.franciolapilla@gmail.com</span><br><hr>
 <span style = "color : black;  user-select : text">Codice sorgente: https://github.com/MicheleFranciolapilla/js-campominato-dom</span>`; 
...
<span style = "color : green;  user-select : text">michele.franciolapilla@gmail.com</span><br><hr>
<span style = "color : black;  user-select : text">Source code: https://github.com/MicheleFranciolapilla/js-campominato-dom</span>`;
...
<span style = "color : green;  user-select : text">michele.franciolapilla@gmail.com</span><br><hr>
<span style = "color : black;  user-select : text">Código fuente: https://github.com/MicheleFranciolapilla/js-campominato-dom</span>`;
